<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:63:"D:\phpStudy\WWW\tp5\public/../adminction/view\index\button.html";i:1512457726;s:61:"D:\phpStudy\WWW\tp5\public/../adminction/view\public\nav.html";i:1512476322;s:64:"D:\phpStudy\WWW\tp5\public/../adminction/view\public\button.html";i:1511967372;s:62:"D:\phpStudy\WWW\tp5\public/../adminction/view\public\page.html";i:1511923378;s:64:"D:\phpStudy\WWW\tp5\public/../adminction/view\public\footer.html";i:1511749595;}*/ ?>
<!--加载头部-->
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-body mycontainer">
    ...
    <div class="layui-fluid">
        ...
        <div class="layui-row layui-bg-gray button_nav">
            ...
            <span class="layui-breadcrumb">
                  ...
                  <a href="javascript:void(0)"><cite>按钮管理</cite></a>
            </span>
        </div>
        <!--操作栏-->
    ...
    <div class="layui-btn-group" id="opearGroup">
        ...
        <?php endforeach; endif; else: echo "" ;endif; ?>
                ...
                <td>
                    <form class="layui-form" action="/admin.php/Index/button" method="get">
                        <div class="layui-form-item">
                            <div class="layui-input-inline">
                                <input type="text" name="button_name" value="<?php if($where['button_name']): ?><?php echo $where['button_name']; endif; ?>" lay-verify="required" placeholder="请输入按钮名" autocomplete="off" class="layui-input">
                            </div>
                            <div class="layui-input-inline">
                                <input type="text" name="button_event" value="<?php if($where['button_event']): ?><?php echo $where['button_event']; endif; ?>" lay-verify="required" placeholder="请输入按钮事件" autocomplete="off" class="layui-input">
                            </div>
                            <div class="layui-input-inline">
                                <input type="text" name="button_type" value="<?php if($where['button_type']): ?><?php echo $where['button_type']; endif; ?>" lay-verify="required" placeholder="请输入按钮类型" autocomplete="off" class="layui-input">
                            </div>
                            <div class="layui-input-inline">
        ...
        <table lay-filter="dataSet" class="dataSet" lay-data="{id:'dataSet'}">
            <thead>
                <tr>
                    ...
                    <td lay-data="{field:'button_id',sort:true}">按钮id</td>
                    <td lay-data="{field:'button_name'}">按钮名</td>
                    <td lay-data="{field:'button_event'}">按钮事件</td>
                    <td lay-data="{field:'button_type'}">按钮类型</td>
                    <td lay-data="{field:'button_sort',sort:true}">按钮排序</td>
                    <td lay-data="{field:'button_desc'}">按钮描述</td>
                </tr>
            </thead>
            <tbody>
            <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                <tr data-id="<?php echo $v['button_id']; ?>">
                    <td><input type="checkbox" lay-skin="primary"></td>
                    <td><?php echo $v['button_id']; ?></td>
                    <td><?php echo $v['button_name']; ?></td>
                    <td><?php echo $v['button_event']; ?></td>
                    <td><?php echo $v['button_type']; ?></td>
                    <td><?php echo $v['button_sort']; ?></td>
                    <td><?php echo $v['button_desc']; ?></td>
                </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            </tbody>
        </table>
        ...
        <hr>
        <!--分页-->
        <div id="page" data-total="<?php echo $total; ?>" data-nowPage="<?php echo $nowPage; ?>" data-perPage="<?php echo $perPage; ?>">

<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:63:"D:\phpStudy\WWW\tp5\public/../adminction/view\index\module.html";i:1512287767;s:61:"D:\phpStudy\WWW\tp5\public/../adminction/view\public\nav.html";i:1512476322;s:64:"D:\phpStudy\WWW\tp5\public/../adminction/view\public\button.html";i:1511967372;s:64:"D:\phpStudy\WWW\tp5\public/../adminction/view\public\footer.html";i:1511749595;}*/ ?>
<!--加载头部-->
<!DOCTYPE html>
<html>
<head>
        ...
        <table lay-filter="dataSet" class="dataSet" lay-data="{id:'dataSet'}">
            <thead>
                <tr>
                    ...
                    <td lay-data="{field:'module_id'}">模块id</td>
                    <td lay-data="{field:'module_name' ,event: 'tree', style:'cursor: pointer;'}">模块名</td>
                    <td lay-data="{field:'module_pid'}">模块父级</td>
                    <td lay-data="{field:'module_code'}">模块代码</td>
                    <td lay-data="{field:'module_url'}">模块链接</td>
                    <td lay-data="{field:'module_sort'}">模块排序</td>
                </tr>
            </thead>
            <tbody>
            <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                <tr data-id="<?php echo $v['module_id']; ?>">
                    <td><input type="checkbox" lay-skin="primary"></td>
                    <td><?php echo $v['module_id']; ?></td>
                    <td><?php echo $v['module_name']; ?></td>
                    <td><?php echo $v['module_pid']; ?></td>
                    <td><?php echo $v['module_code']; ?></td>
                    <td><?php echo $v['module_url']; ?></td>
                    <td><?php echo $v['module_sort']; ?></td>
                </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            </tbody>
        </table>

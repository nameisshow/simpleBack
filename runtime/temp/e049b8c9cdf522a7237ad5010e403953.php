<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:56:"/var/www/tp5/public/../adminction/view/index/admins.html";i:1512443450;s:54:"/var/www/tp5/public/../adminction/view/public/nav.html";i:1512910228;s:57:"/var/www/tp5/public/../adminction/view/public/button.html";i:1511967372;s:57:"/var/www/tp5/public/../adminction/view/public/footer.html";i:1511749595;}*/ ?>
<!--加载头部-->
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="layui-fluid">
        ...
        <div class="layui-row layui-bg-gray button_nav">
            ...
            <span class="layui-breadcrumb">
                  ...
                  <a href="javascript:void(0)"><cite>管理员管理</cite></a>
            </span>
        </div>
        <!--操作栏-->
        ...
        <table lay-filter="dataSet" class="dataSet" lay-data="{id:'dataSet'}">
            <thead>
                <tr>
                    ...
                    <td lay-data="{field:'user_id'}">管理员id</td>
                    <td lay-data="{field:'role_name'}">管理员类型</td>
                    <td lay-data="{field:'username'}">账号</td>
                    <td lay-data="{field:'relaname'}">真实姓名</td>
                    <td lay-data="{field:'mobile'}">手机号码</td>
                    <td lay-data="{field:'login_count'}">访问次数</td>
                    <td lay-data="{field:'last_time'}">上次访问时间</td>
                    <td lay-data="{field:'last_ip'}">上次访问IP</td>
                </tr>
            </thead>
            <tbody>
            <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                <tr data-id="<?php echo $v['user_id']; ?>">
                    ...
                    <td><?php echo $v['relaname']; ?></td>
                    <td><?php echo $v['mobile']; ?></td>
                    <td><?php echo $v['login_count']; ?></td>
                    <td><?php echo date("y-m-d",$v['last_time']); ?></td>
